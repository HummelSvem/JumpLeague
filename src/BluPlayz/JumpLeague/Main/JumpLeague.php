...
class JumpLeague extends PluginBase
{
    ...
    {
        $this->getLogger()->info(self::PREFIX . TextFormat::GOLD . " Aktiviere JumpLeague...");
        ...
        $this->getLogger()->info(self::PREFIX . TextFormat::GOLD . " JumpLeague Aktiviert");
    }
    ...
    {
        unlink(self::$pfad . "JumpLeague/Arenas/" . $arenaname . ".yml");
    }
    ...
    private function initDir()
    {
        ...
        @mkdir($this->getServer()->getDataPath() . "players/Data/JumpLeague");
        @mkdir($this->getServer()->getDataPath() . "players/Data/JumpLeague/Arenas");
        @mkdir($this->getServer()->getDataPath() . "players/Data/JumpLeague/Maps");
    ...
    {
        return file_exists(self::$pfad . "JumpLeague/Arenas/" . $arenaname . ".yml");
    }

    public static function checkArena($arenaname)
    {
        $config = new Config(self::$pfad . "JumpLeague/Arenas/" . $arenaname . ".yml", Config::YAML);
        ...
        if ($config->exists("ArenaName") &&
            ...
            self::copymap(Server::getInstance()->getDataPath() . "worlds/" . $lobbymap, self::$pfad . "JumpLeague/Maps/" . $lobbymap);
            self::copymap(Server::getInstance()->getDataPath() . "worlds/" . $arenamap, self::$pfad . "JumpLeague/Maps/" . $arenamap);
            self::copymap(Server::getInstance()->getDataPath() . "worlds/" . $dmmap, self::$pfad . "JumpLeague/Maps/" . $dmmap);
