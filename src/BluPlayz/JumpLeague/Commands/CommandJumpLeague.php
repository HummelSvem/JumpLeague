...
namespace Bluplayz\JumpLeague\Commands;
...
class CommandJumpLeague extends Command
{
    ...
    {
        parent::__construct("JumpLeague", "", null, ["jl"]);
    }
    ...
    private function reset(CommandSender $sender, $label, array $args)
    {
        ...
        JumpLeague::deleteDirectory(JumpLeague::$pfad . "JumpLeague");
    ...
    private function help(CommandSender $sender, $label, array $args)
    {
        ...
        $helpcommands = [
            "§e/jumpleague help §7[§cZeigt alle JumpLeague Command§7]",
        ...
        if (count($helpcommands) == 0) {
            $sender->sendMessage("§7- §eKeine JumpLeague Commands gefunden");
        }
