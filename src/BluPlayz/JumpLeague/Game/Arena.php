...
class Arena
{
    ...
    public function __construct($arenaid = 0, Config $config)
    {
        ...
        JumpLeague::copymap(JumpLeague::$pfad . "JumpLeague/Maps/" . $lobbymap, Server::getInstance()->getDataPath() . "worlds/" . $lobbyfolder);
        JumpLeague::copymap(JumpLeague::$pfad . "JumpLeague/Maps/" . $arenamap, Server::getInstance()->getDataPath() . "worlds/" . $arenafolder);
        JumpLeague::copymap(JumpLeague::$pfad . "JumpLeague/Maps/" . $dmmap, Server::getInstance()->getDataPath() . "worlds/" . $dmfolder);
